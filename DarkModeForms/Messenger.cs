	...
	public static class Messenger
	{
			...
			MsgIcon Icon = 0, MessageBoxButtons buttons = MessageBoxButtons.OK, bool pIsDarkMode = true)
		{
			...
			if (!string.IsNullOrWhiteSpace(promptText))
			{
				...
				lblPrompt.Height = 48;
				lblPrompt.Padding = new Padding(10, 5, 10, 5);
			...
			Contenedor.ColumnStyles[0].Width = form.ClientSize.Width - 60;
			...
			foreach (KeyValue field in Fields)
			{
				...
				//Always sets first field to active when form opens
				if (currentRow == 0)
                {
					form.ActiveControl = field_Control;
                }
